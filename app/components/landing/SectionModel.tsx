...
export function SectionModel() {
  return (
    ...
    >
      ...
      {/* ── TOP: heading row – full viewport width so H2 wraps at 80vw ── */}
      <div className="relative z-20 w-full flex items-start gap-[10px]">
        <LightSweep />
        ...
        >
          ...
          {/* Section Header – constrained to 80vw so it wraps naturally at that width */}
          <h2
            className="section-header font-garet text-[40px] md:text-[48px] font-[850] leading-[110%] tracking-[0.7px] uppercase text-[#F6F4F1]"
            style={{ margin: 0, maxWidth: 'min(80vw, 1200px)' }}
          >
      ...
      {/* ── BELOW HEADING: card + CTA, constrained left side ── */}
      <motion.div
        variants={contentVariants}
        className="relative z-20 flex flex-col items-start gap-[0px] mt-[20px] md:pr-[calc(50vw-20px)] xl:pr-[620px]"
      >
        {/* Grey card: body + CTA */}
        <div
          style={{
      ...
      {/* ── BOTTOM: large ticket image, anchored bottom-right ── */}
      <motion.div
        variants={contentVariants}
